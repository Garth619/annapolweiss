...
<?php if( !is_page_template("page-dui.php") ): ?>
...
<?php if(!is_page_template( 'page-practice-area-lander.php')):?>
...
var waypointwavelegalrep = new Waypoint({
  element: document.getElementById('legal_rep_section'),
  handler: function(direction) {
    
    
    
    jQuery('#legal_rep_section').addClass('fadein');
...
var waypointwavelegalsvt = new Waypoint({
  element: document.getElementById('wavy_legal_rep'),
  handler: function(direction) {
    
    
    
    jQuery('#wavy_legal_rep').addClass('fadein');
...
<?php if(is_page_template( 'page-aboutus.php') || is_page_template('page-thankyou.php') || is_page_template('page-download_pdfs.php') || is_page_template('page-staff.php') || is_page_template('page-videos.php') || is_page_template('page-contact.php') || is_page_template('page-practiceareas.php') || is_page_template('page-results.php') || is_page_template('page-innerpracticearea.php') ||  is_page_template('page-attprofile.php') ||  is_page_template('page-practice-area-lander.php') ||  is_page_template('page-profilegrid.php')):?>
